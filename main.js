...
/* ═══════════════════════════ PRIVACY POLICY MODAL ENGINE ═══════════════════════════ */
(function PrivacyModalEngine() {
  // 1. Create and inject modal styles dynamically to keep everything self-contained
  ...
  style.textContent = `
    ...
    .privacy-modal-overlay.active .privacy-modal-box {
  ...
  // 2. Create and inject modal HTML structure dynamically
  const modalHTML = `
    <div class="privacy-modal-overlay" id="privacyModal">
      <div class="privacy-modal-box">
        <div class="privacy-modal-header">
          ...
          <button class="privacy-modal-close" id="closePrivacyModal" aria-label="Close modal">
        ...
        <div class="privacy-modal-body">
          ...
          <p>At Pivot Aide, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website or use our services.</p>
          
          <h4>1. Information We Collect</h4>
          <p>We may collect personal identification information from you in a variety of ways, including, but not limited to, when you visit our site, fill out a contact form, request a consultation, or interact with our AI Assistant. This information may include your name, email address, phone number, and company details.</p>
          
          <h4>2. How We Use Your Information</h4>
          <p>We use the information we collect to connect you with our financial and accounting specialists, customize your dashboards, manage Odoo ERP setups, process inquiries, and improve our website performance and user experience.</p>
          
          <h4>3. Data Security</h4>
          <p>We adopt industry-standard data collection, storage, and processing practices and security measures to protect against unauthorized access, alteration, disclosure, or destruction of your personal information.</p>
          
          <h4>4. Sharing Your Information</h4>
          <p>We do not sell, trade, or rent your personal identification information to third parties. We may share information with trusted partners and sub-processors who assist us in operating our website or conducting our business, so long as those parties agree to keep this information confidential.</p>
          
          <h4>5. Contact Us</h4>
          <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:info@pivotaide.com" style="color: #D8B74A; text-decoration: none;">info@pivotaide.com</a>.</p>
        </div>
      </div>
    </div>
  `;
  ...
  // 3. Add Event Listeners for trigger clicks
  const modal = document.getElementById('privacyModal');
  const closeBtn = document.getElementById('closePrivacyModal');

  if (modal && closeBtn) {
    document.addEventListener('click', (e) => {
      // Check if clicked element text is Privacy Policy
      const isPrivacyLink = e.target.tagName === 'A' && e.target.textContent.trim() === 'Privacy Policy';
      if (isPrivacyLink) {
        e.preventDefault();
...
/* ═══════════════════════════ GMAIL DIRECT COMPOSE ENGINE ═══════════════════════════ */
(function GmailComposeEngine() {
  document.addEventListener('click', (e) => {
    // Find parent <a> if clicked on inner elements (e.g. <span>→</span>)
    const anchor = e.target.closest('a');
    if (anchor) {
      const text = anchor.textContent.trim();
      if (text.includes('Schedule a Consultation')) {
        e.preventDefault();
        window.open('https://mail.google.com/mail/?view=cm&fs=1&to=tgeorge@pivotaide.com', '_blank');
      }
    }
  });
})();
